...
attack_model = from_pretrained(model_name_or_path="mistralai/Mixtral-8x7B-Instruct-v0.1",
                               model_name="Nous-Hermes-2-Mixtral-8x7B-DPO")

target_model = from_pretrained(model_name_or_path='meta-llama/Llama-2-7b-chat-hf',
                                model_name='llama-2')

attack_model = from_pretrained(model_name_or_path="meta-llama/Llama-Guard-3-8B",
                               model_name="llama-2")
